...
var decodeTests = []decodeTest{
	...
	},*/
	{
		input: "C105",
		ptr:   new(simplestruct),
		error: "rlp: too few elements for ser.simplestruct",
	},
	/*{
	...
	},*/
	{
		input: "83222222",
		ptr:   new(simplestruct),
		error: "rlp: expected input list for ser.simplestruct",
	},
	{
		input: "C3010101",
		ptr:   new(simplestruct),
		error: "rlp: input list has too many elements for ser.simplestruct",
	},
	{
		input: "C501C3C00000",
		ptr:   new(recstruct),
		error: "rlp: expected input string or byte for uint, decoding into (ser.recstruct).Child.I",
	},
	{
		input: "C0",
		ptr:   new(invalidTail1),
		error: "rlp: invalid struct tag \"tail\" for ser.invalidTail1.A (must be on last field)",
	},
	{
		input: "C0",
		ptr:   new(invalidTail2),
		error: "rlp: invalid struct tag \"tail\" for ser.invalidTail2.B (field type is not slice)",
	},
	{
		input: "C50102C20102",
		ptr:   new(tailUint),
		error: "rlp: expected input string or byte for uint, decoding into (ser.tailUint).Tail[1]",
	},
	...
	{input: "C0", ptr: new(*uint), value: (*uint)(nil)}, //this test case should return err, TODO
...
func (t *testDecoder) DecodeSER(s *Stream) error {
...
func (bd *byteDecoder) DecodeSER(s *Stream) error {
	_, err := s.Uint()
	*bd = 255
	return err
}
...
func ExampleDecode() {
	...
	// Output:
	// Decoded value: ser.example{A:0xa, B:0x14, private:0x0, String:"foobar"}
}
