...
func (e *testEncoder) EncodeSER(w io.Writer) error {
	if e == nil {
...
func (e byteEncoder) EncodeSER(w io.Writer) error {
	w.Write(EmptyList)
	return nil
}
...
var encTests = []encTest{
	...
	// verify that pointer method testEncoder.EncodeSER is called for
	...
	{val: testEncoder{}, error: "rlp: game over: unadressable value of type ser.testEncoder, EncodeSER is pointer method"},
