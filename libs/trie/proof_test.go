...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *dbm.MemDB {
	var provers []func(key []byte) *dbm.MemDB

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *dbm.MemDB {
		proof := dbm.NewMemDB()
