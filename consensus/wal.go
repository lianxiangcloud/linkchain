...
func RegisterWALMessages() {
	ser.RegisterInterface((*WALMessage)(nil), nil)
	ser.RegisterConcrete(types.EventDataRoundState{}, "consensus/wal/EventDataRoundState", nil)
	ser.RegisterConcrete(msgInfo{}, "consensus/wal/MsgInfo", nil)
	ser.RegisterConcrete(timeoutInfo{}, "consensus/wal/TimeoutInfo", nil)
	ser.RegisterConcrete(EndHeightMessage{}, "consensus/wal/EndHeightMessage", nil)
}
