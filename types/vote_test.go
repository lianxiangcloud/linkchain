...
func TestVoteSignable(t *testing.T) {
	...
	expected := `{"@chain_id":"test_chain_id","@type":"vote","block_id":{"hash":"0x0000000000000000000000000000000000000000000000000000000068617368","parts":{"hash":"70617274735F68617368","total":"1000000"}},"height":"12345","round":"2","timestamp":"2017-12-25T03:00:01.234Z","type":2}`
	if signStr != expected {
...
func TestVoteString(t *testing.T) {
	tc := []struct {
		...
		{"Precommit", examplePrecommit().String(), `Vote{56789/3:616464720000 12345/02/2(Precommit) 000000000000 <nil> @ 2017-12-25T03:00:01.234Z}`},
		{"Prevote", examplePrevote().String(), `Vote{56789/3:616464720000 12345/02/1(Prevote) 000000000000 <nil> @ 2017-12-25T03:00:01.234Z}`},
	}
...
func TestVoteVerifySignature(t *testing.T) {
	...
	precommit := new(Vote)
	bs, err := ser.EncodeToBytes(vote)
	require.NoError(t, err)
	err = ser.DecodeBytes(bs, &precommit)
	require.NoError(t, err)
