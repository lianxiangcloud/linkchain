...
func TestKeyStore(t *testing.T) {
	...
	if err := ks.Update(a, "foo", "bar", "test"); err != nil {
...
func TestSignTx(t *testing.T) {
	...
	a1, err := ks.NewAccount(pass, "test")
	if err != nil {
		t.Fatal(err)
	}
	...
	tx := types.NewTransaction(0, a1.Address, big.NewInt(1), 2, big.NewInt(3), []byte{4})
	if _, err := ks.SignTx(accounts.Account{Address: a1.Address}, tx, big.NewInt(12)); err != nil {
		t.Fatal(err)
	}
}
...
func TestSignWithPassphrase(t *testing.T) {
	...
	pass := "passwd"
	acc, err := ks.NewAccount(pass, "test")
	if err != nil {
		t.Fatal(err)
	}
