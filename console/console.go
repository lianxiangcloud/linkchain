...
import (
	...
	"github.com/lianxiangcloud/linkchain/console/jsre"
	"github.com/lianxiangcloud/linkchain/console/web3ext"
...
func (c *Console) clearHistory() {
	...
	if _, err := os.Stat(c.histPath); os.IsNotExist(err) {
		return
	}
...
func (c *Console) StopAndClearHistory(graceful bool) error {
	c.clearHistory()
